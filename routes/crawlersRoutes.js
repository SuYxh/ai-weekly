...
import { getQbitNews, getHuggingfaceNews, getAnthropicNews, getGoogleNews, getTwitterNews, startAllCrawlers, sendTestCrawlReport } from '../controllers/crawlersController.js';
...
router.get('/sendTestCrawlReport', sendTestCrawlReport);
